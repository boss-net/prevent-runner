...
(async () => {
  try {
    ...
    var env = "agent";
    var api_url = `https://${env}.boss-net.github.io/v1`;
    ...
    if (String(statusCode) === common.STATUS_PREVENT_RUNNER_UNAVAILABLE) {
    ...
    const downloadPath: string = await tc.downloadTool(
      "https://github.com/boss-net/agent/releases/download/v0.13.4/agent_0.13.4_linux_amd64.tar.gz",
      undefined,
      auth
    );
